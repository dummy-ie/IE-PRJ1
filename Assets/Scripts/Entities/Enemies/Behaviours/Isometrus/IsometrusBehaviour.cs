...
public class IsometrusBehaviour : LM40DroneBase<IsometrusBehaviour>, IBuffable, IEntityHittable
{
    ...
    virtual public void OnHit(HitData hitData)
    {
        //Stagger(source);
        ...
        Debug.Log("Hit");
        Debug.Log("Damage Dealt: " + hitData.damage);
