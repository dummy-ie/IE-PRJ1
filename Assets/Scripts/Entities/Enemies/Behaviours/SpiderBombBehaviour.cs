...
public class SpiderBombBehaviour : EnemyBase<SpiderBombBehaviour>, IEntityHittable
{

    [Header("Attack")]
    [SerializeField] private LayerMask _playerLayer;
    [SerializeField] private float _explosionDelay;
    [SerializeField] private AttackData _explosionAttack;
    ...
    public abstract class StateBase : EntityState<SpiderBombBehaviour>
    {
        protected StateBase(SpiderBombBehaviour entity) : base(entity) { }
    }

    public class IdleState : StateBase
    {
        private float currentTick;
        public IdleState(SpiderBombBehaviour entity) : base(entity) { }
    ...
    public class PatrolState : StateBase
    {
        ...
        public PatrolState(SpiderBombBehaviour entity) : base(entity) { }
    ...
    {
        private float elapsedTime;
        public DeathState(SpiderBombBehaviour entity) : base(entity) { }
    ...
    public class HurtState : StateBase
    {
        ...
        public HurtState(SpiderBombBehaviour entity) : base(entity) { }
        public override void Enter()
        {
            elapsedTime = 0;
    ...
    {
        public FollowTargetState(SpiderBombBehaviour entity) : base(entity) { }
    ...
    public class AttackState : StateBase
    {
        ...
        private float elapsedTime;
        public AttackState(SpiderBombBehaviour entity) : base(entity) { }
        public override void Enter()
        {
            _entity.rb.velocity = Vector2.zero;
            elapsedTime = 0;
        ...
        public override void Execute()
        {
            ...
            if (elapsedTime >= _entity._explosionDelay)
            {

                PerformAttack(_entity._explosionAttack);

                _entity.SwitchState(_entity._deathState);
