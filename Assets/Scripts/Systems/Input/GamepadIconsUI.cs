...
/// </summary>
public class GamepadIconsUI : MonoBehaviour
{
    ...
    public void OnUpdateBindingDisplay(RebindUI component, string bindingDisplayString, string deviceLayoutName,
        string controlPath)
    {
        ...
        var textComponent = component.RebindButton.transform.Find("ActionBindingText");
